    ...
    public ResponseEntity<Map<String, Object>> establishSession(@RequestBody Map<String, String> payload, HttpServletRequest request) {
        ...
        try {
            ...
            try {
                ...
                return ResponseEntity.status(403).body(java.util.Objects.requireNonNull(Map.<String, Object>of("error", "Usuario no autorizado.")));
            }
            ...
            return ResponseEntity.status(401).body(java.util.Objects.requireNonNull(Map.<String, Object>of("error", msg)));
        }
    }
}
