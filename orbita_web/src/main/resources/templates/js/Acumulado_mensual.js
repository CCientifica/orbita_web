...
function getLaboratorioTotalFromRenderedTable() {
  ...
  // ✅ REGLA ACTUALIZADA: Se elimina la división por 2 a solicitud del usuario.
...
function renderAlineacionEstrategica(model, monthId) {
  ...
  const balanceNeto = sumFaltan + sumSobran;
  ...
  try {
    ...
    const generarFilaHTML = (fila, dataSet, metasSet, metaAnualTotal, metaAnualAcum) => {
      ...
      months.forEach(m => {
        ...
        if (fila.isSumatoriaImg) {
          ...
          keysLab.forEach(k => {
            const v = mesSet[k];
            if (v !== undefined) sumaLabMes += (parseFloat(v) || 0);
          });
          // ✅ REGLA ACTUALIZADA: Se elimina la división por 2 solicitada
          val = Math.round(sumaLabMes);
        } else {
          for (let key of fila.dbKeys) {
            const v = mesSet[key] || mesSet[`URG|${key}`] || mesSet[`URGENCIAS|${key}`] || mesSet[`CIRUGIA_ING|${key}`] || mesSet[`CIRUGIA_EGR|${key}`] || mesSet[`CX-ESP|${key}`] || mesSet[`CE|${key}`] || mesSet[`HEM|${key}`] || mesSet[`HOSP|${key}`] || mesSet[`UCI|${key}`] || mesSet[`UCE|${key}`] || mesSet[`INST|${key}`] || mesSet[`HEMO_ONCO|${key}`] || mesSet[`HEMOCOMPONENTES|${key}`] || mesSet[`ENDO|${key}`] || mesSet[`IMG|${key}`] || mesSet[`IMG-HOS|${key}`] || mesSet[`IMG-AMB|${key}`] || mesSet[`IMG-TOT|${key}`] || mesSet[`LAB|${key}`] || mesSet[`EST|${key}`];
      ...
      let estiloMetaCol = "border: 1px solid #cbd5e1; background: #64748b; padding: 4px; color: #ffffff; font-weight: bold;";
    ...
    let htmlUrg = `
        <div class="card full-width" style="padding:0; overflow-x:auto; border:1px solid #253D5B; margin-top:20px;">
            <table style="min-width: 100%; width: max-content; border-collapse: collapse; font-family: Arial; font-size: 10px; text-align: center;">
                <thead>
    ...
    htmlUrg += `
                <tr style="background: #253D5B; color: #fff; font-weight: bold;">
                    ...
                    <td style="border: 1px solid #fff; background: #64748b;">${totalMetaUrg.toLocaleString()}</td>
    ...
    let htmlHosp = `<div class="card full-width" style="padding:0; overflow-x:auto; border:1px solid #253D5B; margin-top:30px;"><table style="width:100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 10px; text-align: center;"><thead><tr style="background: #253D5B; color: #fff;"><th style="border: 1px solid #fff; padding: 6px; text-align:left;">HOSPITALIZACIÓN</th><th style="border: 1px solid #fff; background: #4E6C9F;">Promedio ${prevYear}</th><th style="border: 1px solid #fff; background: #64748b;">META ANUAL</th>${monthLabels.map(m => `<th style="border: 1px solid #fff; padding: 6px;">${m}</th>`).join('')}<th style="border: 1px solid #fff; background: #4E6C9F;">TOTAL</th><th style="border: 1px solid #fff; background: #4E6C9F;">PROM.</th><th style="background: #B6B5AF; color:#253D5B;">PROYECCIÓN CIERRE ${yearId}</th></tr></thead><tbody>`;
    ...
    htmlHosp += `<tr style="background: #f1f5f9; color: #253D5B; font-weight: bold;"><td style="border: 1px solid #cbd5e1; text-align: left; padding: 5px;">Meta egresos hospitalizacion</td><td style="border: 1px solid #cbd5e1;"></td><td style="border: 1px solid #cbd5e1; background: #64748b; color: #fff;">${fmtInt(totalMetaHosp)}</td>${months.map(m => `<td style="border: 1px solid #cbd5e1;">${fmtInt(metasAnuales[m]?.hospMetaEgresos || 0)}</td>`).join('')}<td style="border: 1px solid #cbd5e1;">${fmtInt(totalMetaHosp)}</td><td style="border: 1px solid #cbd5e1;">${fmtInt(totalMetaHosp / 12)}</td><td style="border: 1px solid #cbd5e1;">Meta Anual</td></tr>`;
    ...
    htmlHosp += `<tr style="background: #f1f5f9; color: #253D5B; font-weight: bold;"><td style="border: 1px solid #cbd5e1; text-align: left; padding: 5px;">Meta egresos UCI</td><td style="border: 1px solid #cbd5e1;"></td><td style="border: 1px solid #cbd5e1; background: #64748b; color: #fff;">${fmtInt(totalMetaUCI)}</td>${months.map(m => `<td style="border: 1px solid #cbd5e1;">${fmtInt(metasAnuales[m]?.uciMetaEgresos || 0)}</td>`).join('')}<td style="border: 1px solid #cbd5e1;">${fmtInt(totalMetaUCI)}</td><td style="border: 1px solid #cbd5e1;">${fmtInt(totalMetaUCI / 12)}</td><td style="border: 1px solid #cbd5e1;">Meta Anual</td></tr>`;
    ...
    htmlHosp += `<tr style="background: #f1f5f9; color: #253D5B; font-weight: bold;"><td style="border: 1px solid #cbd5e1; text-align: left; padding: 5px;">Meta egresos UCE</td><td style="border: 1px solid #cbd5e1;"></td><td style="border: 1px solid #cbd5e1; background: #64748b; color: #fff;">${fmtInt(totalMetaUCE)}</td>${months.map(m => `<td style="border: 1px solid #cbd5e1;">${fmtInt(metasAnuales[m]?.uceMetaEgresos || 0)}</td>`).join('')}<td style="border: 1px solid #cbd5e1;">${fmtInt(totalMetaUCE)}</td><td style="border: 1px solid #cbd5e1;">${fmtInt(totalMetaUCE / 12)}</td><td style="border: 1px solid #cbd5e1;">Meta Anual</td></tr>`;
    ...
    htmlHosp += `<tr style="background: #f1f5f9; color: #253D5B; font-weight: bold;"><td style="border: 1px solid #cbd5e1; text-align: left; padding: 5px;">Meta egresos Hosp + UCE</td><td style="border: 1px solid #cbd5e1;"></td><td style="border: 1px solid #cbd5e1; background: #64748b; color: #fff;">${fmtInt(mHUCE)}</td>${months.map(m => `<td style="border: 1px solid #cbd5e1;">${fmtInt((metasAnuales[m]?.hospMetaEgresos || 0) + (metasAnuales[m]?.uceMetaEgresos || 0))}</td>`).join('')}<td style="border: 1px solid #cbd5e1;">${fmtInt(mHUCE)}</td><td style="border: 1px solid #cbd5e1;">${fmtInt(mHUCE / 12)}</td><td style="border: 1px solid #cbd5e1;">Meta Anual</td></tr>`;
    ...
    htmlCx += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
          ...
          <td style="border: 1px solid #fff; background: #4E6C9F;"></td>
          <td style="border: 1px solid #fff; background: #64748b;">${fmtInt(totalMetaCx)}</td>
    ...
    htmlCxEsp += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
            ...
            <td style="border: 1px solid #fff; background: #4E6C9F;"></td>
            <td style="border: 1px solid #fff; background: #64748b;">${fmtInt(totalMetaUvr)}</td>
    ...
    htmlCE += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
          ...
          <td style="border: 1px solid #fff; background: #4E6C9F;"></td>
          <td style="border: 1px solid #fff; background: #64748b;">${fmtInt(totalMetaCE)}</td>
    ...
    htmlEndo += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
          ...
          <td style="border: 1px solid #cbd5e1; background: #64748b; color: #fff;">${16 * 12}</td>
    ...
    htmlEndo += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
          ...
          <td style="border: 1px solid #cbd5e1; background: #4E6C9F;"></td>
          <td style="border: 1px solid #cbd5e1; background: #64748b; color: #fff;">${130 * 12}</td>
    ...
    htmlImg += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
        ...
        <td style="border: 1px solid #fff; background: #4E6C9F;"></td>
        <td style="border: 1px solid #fff; background: #64748b;">${fmtInt(totalMetaImg)}</td>
    ...
    htmlLab += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
        ...
        <td style="border: 1px solid #cbd5e1; background: #4E6C9F;"></td>
        <td style="border: 1px solid #cbd5e1; background: #64748b; color: #fff;">${fmtInt(11500)}</td>
        ${months.map(m => {
    ...
    htmlLab += `<tr style="background: #253D5B; color: #fff; font-weight: bold;">
        ...
        <td style="border: 1px solid #fff; background: #4E6C9F;"></td>
        <td style="border: 1px solid #fff; background: #64748b; color: #fff;">${fmtInt(totalMetaLab)}</td>
